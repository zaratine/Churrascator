                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="churrascos"><g:message code="secUser.churrascos.label" default="Churrascos" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: secUserInstance, field: 'churrascos', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="meusChurrascos"><g:message code="secUser.meusChurrascos.label" default="Meus Churrascos" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: secUserInstance, field: 'meusChurrascos', 'errors')}">
