                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="facebookId" title="${message(code: 'secUser.facebookId.label', default: 'Facebook Id')}" />
                    ...
                    <g:each in="${secUserInstanceList}" status="i" var="secUserInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: secUserInstance, field: "facebookId")}</td>
