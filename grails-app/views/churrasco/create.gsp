...
<html>
    <head>
		...
		<link rel="stylesheet" href="${resource(dir:'css',file:'autoSuggest.css')}" />
		...
		<script>
			...
			$(document).ready(function() {
				var dados = ${friends}
				$("#participantes").autoSuggest(dados.data, {selectedItemProp: "name", searchObjProps: "name", selectedValuesProp: "id"});
			});
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: churrascoInstance, field: 'data', 'errors')}">
                                    <g:datePicker name="data" precision="minute" value="${churrascoInstance?.data}"  />
                                </td>
                            </tr>

                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="criador"><g:message code="churrasco.criador.label" default="Convidados" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: churrascoInstance, field: 'criador', 'errors')}">
									<g:textField id="participantes" name="participantes" value="${churrascoInstance?.participantes}" />
                                </td>
                            </tr>
