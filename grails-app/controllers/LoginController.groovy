...
class LoginController {
	...
	def facebookLogin = {
		...
		def user = SecUser.findByUsername(facebookId);
		...
		if(user){	
			...
			def name = details?details.name:"";
			
 			user = SecUser.findByFacebookId(facebookId)?: new SecUser(
